...
class AdvertiserTwoProvider implements HotelProviderInterface
{
    private string $url;

    public function __construct()
    {
        $this->url = config('hotels.providers.advertiser_2');
    }
    ...
    public function fetchRawData(): array
    {
        try {
            ...
            Log::error("Advertiser 2 API Error: " . $e->getMessage());
            return [];
        }
    }
